...
def get_regression_data():
    ...
    purpleair_model = pickle.load(open(f'{config.MODELS_FOLDER}/LR_purpleair.pkl', 'rb'))
    n3_model = pickle.load(open(f'{config.MODELS_FOLDER}/LR_n3.pkl', 'rb'))
    atmos_model = pickle.load(open(f'{config.MODELS_FOLDER}/LR_atmos.pkl', 'rb'))
